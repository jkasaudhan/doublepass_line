...
flag = false; time_codes = [13.505049705505371, 28.07526397705078, 40.543548583984375, 51.569576263427734, 57.22391891479492, 66.56085968017578, 75.47666931152344, 87.51717376708984]; values = [13.505049705505371, 28.07526397705078, 40.543548583984375, 51.569576263427734, 57.22391891479492, 66.56085968017578, 75.47666931152344, 87.51717376708984]; if time_codes.length == values.length values.each_with_index { |val, i| if (val-time_codes[i]).abs > 1 flag = false; break; end; flag = true; } end;
